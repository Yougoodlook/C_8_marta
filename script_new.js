...
class Particle {
    constructor(position, targetPosition) {
        ...
        this.baseTargetPosition = targetPosition.clone(); // сохраняем исходную позицию для колыхания
        ...
        this.waveAmplitude = 0.08; // амплитуда колыхания
        this.waveFrequency = 2 + Math.random() * 2; // частота колыхания
    ...
    getWavePosition(time, phase) {
        // Создаем колыхающееся движение вокруг целевой позиции
        ...
        // Во время разрушения и максимальной деформации колыхание слабее
    ...
    // Кэширование методов обновления
    updateMethods = {
...
// Статические переменные для переиспользования
...
class HeartAnimation {
    ...
    updateParticles(deltaTime) {
        ...
        for (let i = 0; i < CONFIG.particleCount; i++) {
            ...
            particle.update(deltaTime, phase, this.animationTime);
            ...
            // Динамический неоновый цвет на основе яркости
        ...
        // Обновление интенсивности эмиссии
        this.material.emissiveIntensity = 0.8 + Math.sin(this.animationTime * 2) * 0.4;
    }

    updateLighting() {
        const time = this.animationTime;
        const sinTime2 = Math.sin(time * 2);
        const sinTime3 = Math.sin(time * 1.5);

        // Пульсирующее основное освещение
