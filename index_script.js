const canvas = document.getElementById('heart');
        ...
        // Текст твоей песни
        const lyrics = "Не парься по мелочам — почти всё, что сейчас кажется важным и тревожным, через несколько дней станет просто воспоминанием, и ты об этом забудешь.".split(' ');
