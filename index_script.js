const canvas = document.getElementById('heart');
        ...
        // Текст твоей песни
        const lyrics = "Лучший план на вечер — это тёплый чай, мягкий плед, приглушённый свет и ни одной строчки в списке дел, потому что полное отсутствие планов иногда восстанавливает лучше любого выходного.".split(' ');
