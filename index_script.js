const canvas = document.getElementById('heart');
        ...
        // Текст твоей песни
        const lyrics = "С днём рождения! Желаю, чтобы проблем было поменьше, а поводов для смеха побольше. Пусть люди вокруг будут адекватными, кофе горячим, а свободного времени хватало на всё, что любишь.".split(' ');
